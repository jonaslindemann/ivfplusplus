...
// ------------------------------------------------------------
void CIvfUcs3d::setRotation(double vx, double vy, double vz, double theta)
{
	m_vx = vx;
	m_vy = vy;
	m_vz = vz;
...
// ------------------------------------------------------------
void CIvfUcs3d::setTranslation(double tx, double ty, double tz)
{
	m_tx = tx;
	m_ty = ty;
	m_tz = tz;
...
// ------------------------------------------------------------
void CIvfUcs3d::getRotation(double & vx, double & vy, double & vz, double & theta)
{
	vx = m_vx;
	vy = m_vy;
	vz = m_vz;
...
// ------------------------------------------------------------
void CIvfUcs3d::getTranslation(double & tx, double & ty, double & tz)
{
	tx = m_tx;
	ty = m_ty;
	tz = m_tz;
...
// ------------------------------------------------------------
void CIvfUcs3d::transform(double wx, double wy, double wz, double & sx, double & sy, double & sz)
{
...
// ------------------------------------------------------------
void CIvfUcs3d::transformWorld(double sx, double sy, double sz, double & wx, double & wy, double & wz)
{
...
// ------------------------------------------------------------
void CIvfUcs3d::intersect(double x0, double y0, double z0, double i, double j, double k, double &x, double &y, double &z)
{
	double a, b, c, d;
	double t;
...
// ------------------------------------------------------------
CIvfVec3d& CIvfUcs3d::intersect(CIvfVec3d &origin, CIvfVec3d &vec)
{
	double x, y, z;
	double vx, vy, vz;
	double ix, iy, iz;
	CIvfVec3d& intersection = ivfGetTempVec3d();
...
// ------------------------------------------------------------
void CIvfUcs3d::snap(double & x, double & y, double & z)
{
	if (x>0)
...
// ------------------------------------------------------------
CIvfVec3d& CIvfUcs3d::transformWorld(CIvfVec3d& vec)
{
...
// ------------------------------------------------------------
CIvfVec3d& CIvfUcs3d::transform(CIvfVec3d& vec)
{
	CIvfVec3d& r = ivfGetTempVec3d();
	double x, y, z;
	vec.getComponents(x, y, z);
...
// ------------------------------------------------------------
CIvfVec3d& CIvfUcs3d::snap(CIvfVec3d& vec)
{
	CIvfVec3d& r = ivfGetTempVec3d();
	double x, y, z;
	vec.getComponents(x, y, z);
