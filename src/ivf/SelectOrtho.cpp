...
// IvfSelectOrtho.cpp: implementation of the SelectOrtho class.
//
//////////////////////////////////////////////////////////////////////
...
void SelectOrtho::setViewport(int width, int height)
{
	m_width = width;
	m_height = height;
}

void SelectOrtho::getViewport(int &width, int &height)
{
	width = m_width;
	height = m_height;
}
