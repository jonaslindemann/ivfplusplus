...
#ifndef _CIvfArrow_h_
#define _CIvfArrow_h_
 ...
 */
class IVF_API CIvfArrow : public CIvfComposite {
public:
	 ...
	 * @param ivfVector Reference to a CIvfVec3d instance to which
...
private:
	double m_offset;
	int m_arrowType;
	CIvfCylinderPtr m_tail;
	CIvfConePtr m_head;
	CIvfConePtr m_extraHead;
	double m_tailRadius;
	double m_headRadius;
	double m_headSize;
	double m_length;
