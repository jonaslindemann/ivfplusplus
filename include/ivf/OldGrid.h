 ...
 * derived from a LineSet. (Soon obsolete)
 * @author Jonas Lindemann
 */
class IVF_API OldGrid : public SimpleLineSet {
public:
	...
	IvfClassInfo("OldGrid",SimpleLineSet);
	IvfStdFactory(OldGrid);
