 ...
 */
class IVF_API Camera : public View {
public:
	enum TStereoEye {
		SE_LEFT,
		SE_RIGHT
...
public:
	...
	IvfClassInfo("Camera", View);
	IvfStdFactory(Camera);
	 ...
	 * direction.
	 */
	void setForwardVector(Vec3d& vec);
